...
class _CreateEventState extends State<CreateEvent> {
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          if (isValidForm) {
                            ...
                            createEvent(title: task, description: description, starttime: startDateTime, endtime: endDateTime, type: eventtype!);
                          }
                        },
                        child: const Text(
                            'Confirm',
  ...
  Future createEvent({required String title, required int type, required DateTime starttime, required DateTime endtime, String? description}) async {
    final docEvent = FirebaseFirestore.instance.collection('eventtest').doc();
